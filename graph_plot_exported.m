classdef graph_plot_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        GraphpresentationdemoLabel     matlab.ui.control.Label
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create GraphpresentationdemoLabel
            app.GraphpresentationdemoLabel = uilabel(app.GraphpresentationdemoUIFigure);
            app.GraphpresentationdemoLabel.HorizontalAlignment = 'center';
            app.GraphpresentationdemoLabel.FontName = 'Arial';
            app.GraphpresentationdemoLabel.FontSize = 20;
            app.GraphpresentationdemoLabel.FontAngle = 'italic';
            app.GraphpresentationdemoLabel.FontColor = [0.149 0.149 0.149];
            app.GraphpresentationdemoLabel.Position = [288.5 606 234 24];
            app.GraphpresentationdemoLabel.Text = 'Graph presentation demo';
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = graph_plot_exported
